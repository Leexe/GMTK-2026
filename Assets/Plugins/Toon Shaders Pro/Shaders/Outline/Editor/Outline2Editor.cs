...
namespace ToonShadersPro.URP
{
    ...
    [CustomEditor(typeof(OutlineSettings2))]
#else
    [VolumeComponentEditor(typeof(OutlineSettings2))]
#endif
    public class Outline2Editor : VolumeComponentEditor
    {
        ...
        {
            var o = new PropertyFetcher<OutlineSettings2>(serializedObject);
        ...
        {
            if (!ToonShaderUtility.CheckEffectEnabled<OutlineFeature2>())
            {
                ...
                {
                    ToonShaderUtility.AddEffectToPipelineAsset<OutlineFeature2>();
                }
            }
