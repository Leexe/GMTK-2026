...
{
    public class OutlineFeature2 : ScriptableRendererFeature
    {
        ...
        {
            var settings = VolumeManager.instance.stack.GetComponent<OutlineSettings2>();
        ...
        class OutlineRenderPass : ScriptableRenderPass
        {
            ...
            private static void DrawObjects(ScriptableRenderContext context, ref RenderingData renderingData, CommandBuffer cmd, OutlineSettings2 settings, Material drawMaterial, int passIndex, ProfilingSampler profilingSampler)
            {
                using (new ProfilingScope(cmd, profilingSampler))
                {
            ...
            public RendererListHandle GetRendererList(RenderGraph renderGraph, UniversalRenderingData renderingData, Camera camera, OutlineSettings2 settings, List<ShaderTagId> shaderTagIDs, Material material)
            {
                var cullingResults = renderingData.cullResults;
