...
{
    [System.Serializable, VolumeComponentMenu("Toon Shaders Pro/Outlines2")]
    public sealed class OutlineSettings2 : VolumeComponent, IPostProcessComponent
    {
        public OutlineSettings2()
        {
            displayName = "Outlines2";
        }
